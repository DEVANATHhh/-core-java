class Product {
	...
	Product(String name, String make, String mfgDate, double cost,
			ProductType productType, String seller,
			ProductWarrentyYear productWarrentyYear,
			boolean warrentyExpired, int uniquwId, String originCountry) {
	...
	void productInfo() {
		...
		System.out.println("Warranty Year: " + productWarrentyYear);
		System.out.println("Warranty Expired: " + warrentyExpired);
		System.out.println("Unique Id: " + uniquwId);
